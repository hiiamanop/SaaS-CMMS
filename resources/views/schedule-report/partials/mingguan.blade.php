...
<div class="mb-4 bg-yellow-50 border border-yellow-200 rounded-lg p-4 text-sm text-yellow-800 flex items-center gap-2">
    ...
    <span><strong>{{ $weeklySchedule->equipment_name }}</strong> — belum ada template checksheet. <a href="{{ route('maintenance-schedules.show', $weeklySchedule) }}" class="underline font-medium">Tambahkan template di sini.</a></span>
</div>
@php continue; @endphp
@endif
<div class="mb-4">
