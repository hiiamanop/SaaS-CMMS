            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                ...
                <div class="md:col-span-3">
                    ...
                    <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-5">
                        <div>
                            ...
                            <input name="asset_code" value="{{ old('asset_code', $asset->asset_code) }}" required class="w-full px-3 py-2 border border-gray-300 rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-blue-500 @error('asset_code') border-red-400 @enderror">
                        ...
                        <div>
                            ...
                            <input name="name" value="{{ old('name', $asset->name) }}" required class="w-full px-3 py-2 border border-gray-300 rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-blue-500 @error('name') border-red-400 @enderror">
                        ...
                        <div>
                            ...
                            <input name="category" value="{{ old('category', $asset->category) }}" required placeholder="e.g. Inverter, Transformer" class="w-full px-3 py-2 border border-gray-300 rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-blue-500">
                        </div>
                        <div>
                            <label class="block text-sm font-medium text-gray-700 mb-1.5">Internal Location <span class="text-red-500">*</span></label>
                            <input name="location" value="{{ old('location', $asset->location) }}" required placeholder="e.g. Control Room, Field A" class="w-full px-3 py-2 border border-gray-300 rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-blue-500">
                        </div>
                        <div>
                ...
                <div class="md:col-span-3">
                    ...
                    <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-5">
                        ...
                        <div><label class="block text-sm font-medium text-gray-700 mb-1.5">Model / Type</label><input name="model" value="{{ old('model', $asset->model) }}" class="w-full px-3 py-2 border border-gray-300 rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-blue-500"></div>
                ...
                <div class="md:col-span-3">
                    ...
                    <textarea name="description" rows="4" class="w-full px-3 py-2 border border-gray-300 rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-blue-500 resize-none">{{ old('description', $asset->description) }}</textarea>
                </div>
            </div>

            <div class="flex gap-3 pt-6 border-t border-gray-100">
                <button type="submit" class="px-6 py-2.5 bg-blue-600 text-white rounded-lg text-sm font-bold hover:bg-blue-700 transition-all shadow-sm">Update Asset</button>
