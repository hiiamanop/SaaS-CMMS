    ...
    <div class="bg-white rounded-xl border border-gray-200 shadow-sm p-6">
        <form action="{{ route('work-orders.store') }}" method="POST" class="space-y-6" x-data="{checklist:[''], isExternal:false}">
            ...
            <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
                ...
                <div class="lg:col-span-2 space-y-6">
                    <div>
                        ...
                        <input name="title" value="{{ old('title') }}" required placeholder="e.g. Inverter Repair" class="w-full px-3 py-2 border border-gray-300 rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-blue-500 @error('title') border-red-400 @enderror">
                    ...
                    <div class="grid grid-cols-1 sm:grid-cols-2 gap-5">
                        ...
                        <div x-show="!isExternal" x-transition:enter="transition ease-out duration-200" class="sm:col-span-2">
                            ...
                            <select name="asset_id" :required="!isExternal" class="w-full px-3 py-2 border border-gray-300 rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-blue-500 @error('asset_id') border-red-400 @enderror">
                        ...
                        <div x-show="isExternal" x-transition:enter="transition ease-out duration-200" class="sm:col-span-2">
                            ...
                            <input name="client_name" value="{{ old('client_name') }}" :required="isExternal" placeholder="Masukkan nama client..." class="w-full px-3 py-2 border border-blue-300 bg-blue-50/30 rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-blue-500">
                ...
                <div class="space-y-6">
                    <div class="bg-gray-50 rounded-xl p-5 border border-gray-200">
                        ...
                        <div class="space-y-4">
                            <div>
                                ...
                                <input name="due_date" type="date" value="{{ old('due_date') }}" required class="w-full px-3 py-2 border border-gray-300 rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-blue-500">
                            </div>
                            <div class="pt-2">
                    ...
                    <div class="bg-gray-50 rounded-xl p-5 border border-gray-200">
                        ...
                        <div class="space-y-2">
                            <template x-for="(item, index) in checklist" :key="index">
                                <div class="flex gap-2">
                                    <input :name="'checklist['+index+']'" x-model="checklist[index]" placeholder="New task..." class="flex-1 px-3 py-2 border border-gray-300 rounded-lg text-xs focus:outline-none focus:ring-2 focus:ring-blue-500">
                        ...
                        <button type="button" @click="checklist.push('')" class="mt-3 inline-flex items-center gap-1.5 text-xs text-blue-600 hover:text-blue-700 font-bold">
            ...
            <div class="flex gap-3 pt-6 border-t border-gray-100">
                <button type="submit" class="px-6 py-2.5 bg-blue-600 text-white rounded-lg text-sm font-bold hover:bg-blue-700 shadow-sm transition-all">Submit Order</button>
                <a href="{{ route('work-orders.index') }}" class="px-6 py-2.5 border border-gray-300 text-gray-700 rounded-lg text-sm font-medium hover:bg-gray-50">Cancel</a>
            </div>
