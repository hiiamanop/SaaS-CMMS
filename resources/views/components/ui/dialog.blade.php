...
>
    ...
    <div
        x-show="show"
        class="mb-6 bg-white rounded-[20px] border border-[#E5E5E5] overflow-hidden shadow-2xl transform transition-all sm:w-full {{ $maxWidthClass }} sm:mx-auto relative z-10"
        x-transition:enter="ease-out duration-200"
