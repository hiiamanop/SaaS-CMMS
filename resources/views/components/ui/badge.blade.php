...
@php
    $baseClasses = 'inline-flex items-center rounded-full px-2.5 py-0.5 text-xs font-semibold transition-colors focus:outline-none focus:ring-2 focus:ring-[#697FAE] focus:ring-offset-2 select-none';

    $variants = [
        'default'     => 'bg-[#E5EAF4] text-[#1E293B] border border-[#697FAE]/30',
        ...
        'success'     => 'bg-[#697FAE] text-white font-bold shadow-xs',
